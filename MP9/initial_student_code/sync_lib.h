...
public:
	...
	virtual ~ProcessSharedSemaphore();
...
public:
	...
	virtual ~ThreadSharedBoundedBuffer();
	virtual std::string push_back(std::string str);
	virtual std::string retrieve_front();
	virtual int size();
};
...
public:
	...
	virtual ~MessageQueueBoundedBuffer();
	virtual std::string push_back(std::string str);
	virtual std::string retrieve_front();
	virtual int size();
...
public:
	...
	virtual ~SharedMemoryBoundedBuffer();
	virtual std::string push_back(std::string str);
	virtual std::string retrieve_front();
	virtual int size();
...
/*
 	This can help with error-handling inside constructors.
 */
